...
import MobilityViewer.mightylib.util.enginecommand.BaseCommand;
...
public class ReloadGenCom extends BaseCommand {
    ...
    public void help() {
        ...
        System.out.println("4. reload help : MobilityViewer.project.display help's tips about the command");
    }
}
